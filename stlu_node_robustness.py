...
"""This Returns the confidence interval of normal cdf
Input: Mean Sigma Confidence Interval"""
...
"""Save the plot of a signal with specific name"""
...
"""The formula in the way of f(x) >= 0"""
